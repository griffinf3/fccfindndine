...
componentDidMount(){
   // this.setState({tmpusrnme:this.props.location.query.tmpusrnme});
   // console.log('tmpusrnme'+ this.props.location.query.tmpusrnme);
    //console.log('tempun'+ this.props.location.query.tmpusrnme);
  ...
  processForm(event) {
    ...
    console.log('processing'+ tmpusrnme); 
