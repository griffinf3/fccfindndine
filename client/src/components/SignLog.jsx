...
constructor(props){
        super(props);
        this.state = { isAuthenticated: false, user: {local: {username: ''}}, token: '', showDialog: false};
...
this.props.onPresUpdate({total: responseJson.total, page: responseJson.page, offset: responseJson.offset}); }).then(() => {browserHistory.push('/');});
...
render() {
    ...
    (
      <TwitterLogin text="Twitter" loginUrl="/api/v1/auth/twitter"
